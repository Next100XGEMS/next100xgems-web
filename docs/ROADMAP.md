...
Radar PumpSwap linkage + prospective shadow collection — DEVELOPMENT READY / METHODOLOGY DATA PENDING. Added an official read-only Pump `migrate`/`migrate_v2` to canonical PumpSwap Pool decoder and a restart-safe, bounded shadow runner for real Solana admissions, T+5M through T+24H checkpoints, exact observations, holder/top-account context, lifecycle-aware market stages, market fallback, provenance and cost telemetry. A bounded live validation linked 7/10 committed completed cases; the expansion reached 62 real Pump admissions against a 100-token target and captured 29 checkpoints (14 T+5M, 15 T+15M). The live source yielded no further unique candidates within the bounded continuation. `SHADOW_COLLECTION_READY` is implementation-ready; `METHODOLOGY_DATA_READY` remains false until later checkpoints and objective future labels mature. No scoring, AI, public activation, production scheduling or trading/execution was added. See [RADAR_SHADOW_COLLECTION.md](RADAR_SHADOW_COLLECTION.md).
