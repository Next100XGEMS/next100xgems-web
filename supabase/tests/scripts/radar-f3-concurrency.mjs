...
async function main() {
  ...
  assert.equal(migrations.length, 20, "F3 harness migration inventory must include exactly twenty migrations");
  ...
  pass("F3 scratch database replays all twenty real migrations");
