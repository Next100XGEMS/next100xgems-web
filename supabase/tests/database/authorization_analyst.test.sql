...
insert into public.articles (id, title, slug, author_id, status, published_at) values
 ('00000000-0000-4000-8000-000000001033', 'Published', 'analyst-published', '00000000-0000-4000-8000-000000001032', 'PUBLISHED', now()),
 ('00000000-0000-4000-8000-000000001034', 'Own draft', 'analyst-draft', '00000000-0000-4000-8000-000000001031', 'DRAFT', null);
