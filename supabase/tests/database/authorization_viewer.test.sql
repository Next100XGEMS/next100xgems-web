...
insert into public.articles (id, title, slug, author_id, status, scheduled_at, published_at)
values ('00000000-0000-4000-8000-000000001022', 'Published', 'viewer-published', '00000000-0000-4000-8000-000000001021', 'PUBLISHED', null, now()), ('00000000-0000-4000-8000-000000001023', 'Future', 'viewer-future', '00000000-0000-4000-8000-000000001021', 'SCHEDULED', now() + interval '1 day', null);
